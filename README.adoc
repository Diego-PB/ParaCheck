...
== Liste des livrables par Sprints et Lien pratiques 
...
|   | Sprint 2 | Release de fin de Sprint 2 | https://github.com/Diego-PB/ParaCheck/releases/tag/V2[Release de fin de Sprint 2] | Release de fin de Sprint 2
|===
