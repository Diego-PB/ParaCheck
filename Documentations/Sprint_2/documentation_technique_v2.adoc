...
= Documentation Technique sprint n°2 SAE-5.01-ParaCheck
...
** Questionnaire pour valider l'état météoroligue extérieur

** Questionnaire pour valider l'état du matériel

** Questionnaire pour valider l'état du parapentiste

** Information d'un exercice de respiration  pour gestion du stress

* Entrer ses données de vol

** Formulaire complets pour entrer ses données de vol et les enregistrer

** Formulaire pour avoir un radar de compétences pour suivre sa progression

* Historique de vols

** Consulter l’historique des données de vols

** Consulter le détail de ses vols

* Paramètres

** Gérer les sites de vols (via import map notamment)

** Exporter ses données 

*** en PDF pour une review annuelle

*** en JSON pour transfert d'appareils (import disponible)
...
│       |   │   ├── breathing_stress.dart
│       |   │   ├── flight_condition.dart
│       |   │   ├── flights_history.dart
│       |   │   ├── Home_page.dart
│       |   │   ├── manage_sites.dart
│       |   │   ├── mavie.dart
│       |   │   ├── personal_weather.dart
│       |   │   ├── postflight_debrief.dart
│       |   │   ├── radar_page.dart
│       |   │   ├── settings.dart
│       |   │   ├── splash_screen.dart
│       |   │   └── uiktdemopage.dart
